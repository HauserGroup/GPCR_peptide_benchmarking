...
plt.xlabel("Receptor", fontsize=16)
plt.ylabel("Count", fontsize=16)
plt.title("Number of interacting generic residue numbers per receptor", fontsize = 20)
...
plt.text(45, avg_to_plot + 0.8, f'Average number of interactions per receptor = {round(avg_to_plot, 2)}', fontsize=14)
plt.tight_layout()
plt.ylim(0, 30)
plt.savefig(f"{plot_dir}/interacting_generic_residue_numbers_per_receptor.svg", dpi = 600)